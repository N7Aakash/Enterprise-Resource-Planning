var TableDatatables = function(){
    var handleProductTable = function(){
        ...
        var oTable = productTable.dataTable({
            ...
            "ajax":{
                url:
                "http://localhost/erp1/pages/scripts/product/manage.php",
                type: "POST",
            },
            "lengthMenu": [
                [5,15,20,-1],
...
//                    if(res[1]!=""){
//                        return "<img class='img-responsive' height='75px' src='http://localhost/erp1/assets/products/images/"+ row[0] + "'/>";
//                    }
//                    else{
...
//        }
        ...
        productTable.on('click', '.edit', function(e){
            ...
            $.ajax({
                url:"http://localhost/erp1/pages/scripts/category/fetch.php",
                method: "POST",
                data: {product_id:$id},
                dataType: "json",
