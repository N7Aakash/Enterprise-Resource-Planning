                                ...
                                <form action="scripts/supplier/add.php" id="add_supplier_form" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="textarea" name="supplier_address" class="form-control" placeholder="Address">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input name="gst_no" type="text" class="form-control" placeholder="Email" /> </div>
                                                <div class="col-md-4">
                                                </div>
                                        </div>
...
<![endif]-->
    ...
    <script>
     ...
     <?php
      ...
      ?>
<script>toastr["warning"]("Supplier already exists", "Supplier Error")</script>
      <?php
