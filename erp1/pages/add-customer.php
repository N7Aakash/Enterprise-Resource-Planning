                                ...
                                <form action="scripts/customer/add.php" id="add_customer_form" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="textarea" name="customer_address" class="form-control" placeholder="Address">
                                            </div>
                                        </div>
                                        <div class="form-group">
...
<![endif]-->
    ...
    <script>
     ...
     <?php
      ...
      ?>
<script>toastr["warning"]("Customer already exists", "Customer Error")</script>
      <?php
