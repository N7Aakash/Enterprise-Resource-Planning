    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form action="http://<?php echo BASE_SERVER;?>/erp1/pages/scripts/supplier/edit.php" method="POST">
                        <div class="form-body">
...
<!--END OF EDIT BUTTON MODAL-->
          ...
          <span aria-hidden="true">&times;</span>
                                    ...
                                    <div class="modal-footer">
                                       <form action="http://localhost/erp1/pages/scripts/supplier/delete.php" method="POST">
...
<![endif]-->
      ...
      ?>
        <?php
         if(isset($_SESSION['status']) && $_SESSION['status'] == ERROR_INVALID_MODAL){
      ?>
          <script>toastr["warning"]("contact already exists", "Supplier Contact error")</script>
      <?php
         unset($_SESSION['status']);
         }
      ?>
