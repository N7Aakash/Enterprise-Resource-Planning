                    ...
                    <div class="page-content-wrapper">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="portlet">
                                        <a href="http://<?php echo BASE_SERVER;?>/erp1/pages/manage-product.php" class="btn red">
...
<span class="required"> * </span>
           ...
           <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="text" name="eoq" class="form-control" placeholder="EOQ"/>
                    </div>
                </div>
            </div>
        </div>
         ...
         <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label col-md-4">Additional Desc </label>
                    <div class="col-md-8">
                        <textarea name="additonal_specification" id="additonal_specification" class="form-control" rows="3"  ></textarea>
