    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form action="http://<?php echo BASE_SERVER;?>/erp1/pages/scripts/customer/edit.php" method="POST">
                        <div class="form-body">
...
<!--END OF EDIT BUTTON MODAL-->
          ...
          <span aria-hidden="true">&times;</span>
                                    ...
                                    <div class="modal-footer">
                                       <form action="http://localhost/erp1/pages/scripts/customer/delete.php" method="POST">
...
<![endif]-->
      ...
      ?>
          <script>toastr["warning"]("contact already exists", "Customer Contact error")</script>
      <?php
         unset($_SESSION['status']);
         }
      ?>
