...
$columns = array("customer.customer_name","customer.customer_address","customer.customer_email","customer_contact","customer.gst_no");

$query = "SELECT * FROM customer WHERE customer.deleted=0";
...
//$columns = array("customer.customer_name","customer.hsn_code","gst.gst_rate");
//$query = "SELECT * FROM customer, gst WHERE customer.hsn_code = gst.hsn_code HAVING customer.deleted=0";
//
//if(isset($_POST["search"]["value"])){
//    $query .= " AND (customer.customer_name like '%".$_POST["search"]["value"]."%' OR customer.hsn_code like '%". $_POST['search']['value']."%')";
//}
//if(isset($_POST["order"])){
//    $query .= " ORDER BY ".$columns[$_POST['order']['0']['column']]." ".$_POST['order']['0']['dir'];
//}
...
//function get_all_data($connection){
//    $query = "SELECT * FROM customer, gst WHERE customer.hsn_code = gst.hsn_code";
//    return (mysqli_num_rows(mysqli_query($connection, $query)));
//}
